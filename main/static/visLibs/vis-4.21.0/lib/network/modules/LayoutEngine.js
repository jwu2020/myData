...
class LayoutEngine {
  ...
  setupHierarchicalLayout() {
    if (this.options.hierarchical.enabled === true && this.body.nodeIndices.length > 0) {
      // get the size of the largest hubs and check if the main has defined a level for a node.
      let node, nodeId;
      ...
      // if the main defined some levels but not all, alert and run without hierarchical layout
